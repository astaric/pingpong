...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.start_time'
        db.add_column(u'pingpong_match', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Match.end_time'
        db.add_column(u'pingpong_match', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.start_time'
        db.delete_column(u'pingpong_match', 'start_time')

        # Deleting field 'Match.end_time'
        db.delete_column(u'pingpong_match', 'end_time')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bracket.name'
        db.alter_column(u'pingpong_bracket', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Bracket.name'
        db.alter_column(u'pingpong_bracket', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

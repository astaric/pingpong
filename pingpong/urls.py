...
urlpatterns = patterns('',
    ...
    url(r'^dashboard/$', 'pingpong.dashboard.views.upcoming_matches', name='upcoming_matches'),
    url(r'^dashboard/current/$', 'pingpong.dashboard.views.current_matches', name='current_matches'),
    url(r'^dashboard/tableinfo/(?P<table_id>\d+)/', 'pingpong.dashboard.views.set_score', name='set_score'),
